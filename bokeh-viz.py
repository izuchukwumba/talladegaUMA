...
# Add a tile provider (CARTODBPOSITRON)
...
flight_source = ColumnDataSource(data={'icao24': [], 'callsign': [], 'origin_country': [], 'time_position': [], 'last_contact': [], 'long': [], 'lat': [], 'baro_altitude': [], 'on_ground': [], 'velocity': [], 'true_track': [], 'vertical_rate': [], 'sensors': [], 'geo_altitude': [], 'squawk': [], 'spi': [], 'position_source': [], 'x': [], 'y': [], 'rot_angle': [], 'url': [], 'w': [], 'h': []})

# Plot aircraft positions
p.image_url(url='url', x='x', y='y', source=flight_source, anchor='center', angle_units='deg', angle='rot_angle', w='w', h='h')
p.circle('x', 'y', source=flight_source, fill_color='red', hover_fill_color='yellow', size=10, fill_alpha=0.8, line_width=0)
