...
class MainChat {
  ...
  static LoadEventHandlers() {
    Fake = [
      ...
      "Hope they gave you the pretzels you like?",
      "next time, i promise",
      "That's good. If you have any issues let me know okay?",
      "Not too bad, thanks",
      "What do you do?",
      "That's awesome",
  ...
  static fakeMessage() {
    ...
    $(
      '<div class="message loading new"><figure class="avatar"><img src="/public/img/female-placeholder.jpg" /></figure><span></span></div>'
    ).appendTo($(".mCSB_container"));
    MainChat.updateScrollbar();
    setTimeout(() => {
      $(".message.loading").remove();
      $(
        '<div class="message new"><figure class="avatar"><img src="/public/img/female-placeholder.jpg" /></figure>' +
          Fake[i] +
          "</div>"
      )
        .appendTo($(".mCSB_container"))
